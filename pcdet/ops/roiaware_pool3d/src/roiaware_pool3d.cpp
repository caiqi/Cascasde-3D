...
int points_in_multi_boxes_gpu(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor box_idx_of_points_tensor, int max_num_of_points_per_box){
    // params boxes: (B, N, 7) [x, y, z, dx, dy, dz, heading] (x, y, z) is the box center
    // params pts: (B, npoints, 3) [x, y, z]
...
//    CHECK_INPUT(box_idx_of_points_tensor);
    ...
    points_in_multi_boxes_launcher(batch_size, boxes_num, pts_num, max_num_of_points_per_box, boxes, pts, box_idx_of_points);
