...
def eval_one_epoch(cfg, model, dataloader, epoch_id, logger, dist_test=False, save_to_file=False, result_dir=None):
    ...
    results_file = result_dir / 'result.pkl'
    if os.path.exists(results_file):
        print("Results file existing, skip model inference")
        with open(result_dir / 'result.pkl', 'rb') as f:
            print("Loading detection results from : {}".format(result_dir / 'results.pkl'))
    ...
    for i, batch_dict in enumerate(dataloader):
        ...
        model_duration = run_end_time - model_start_time
        run_time += run_duration
        # print("Iteration: {} time: {}".format(i, model_duration))
    ...
    with open(result_dir / 'result.pkl', 'wb') as f:
        print("saving detection results to : {}".format(result_dir / 'results.pkl'))
